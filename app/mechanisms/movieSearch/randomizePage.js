 ...
 * Creates preFilled array, makes copy of it with a shuffle. Returnes ranndom element and removes it from our collection so we can
 * push updated collection into our cache.
 *
 * - if this func runs for the first time
 * - if preFilled array exist
 * - if there were filters update
